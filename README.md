...
- Aumentaram a eficiência e velocidade de entrega de projetos
- Contribuíram para crescimento de vendas e presença digital
- Automatizaram processos e reduziram retrabalho
- Levaram sistemas do desenvolvimento à produção com estabilidade

Trabalho com **metodologias ágeis (Scrum e Kanban)**, participando ativamente de planejamento, organização de tarefas e melhoria contínua, sempre com foco em qualidade e impacto real.
...
Formação com forte base prática e teórica em computação, incluindo:
